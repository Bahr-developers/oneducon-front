...
const EditProduct = ({ product }: EditProductProps) => {
    ...
    const handleTanUzs = (value: number) => {
        setData((prev) => ({
            ...prev,
            tan_narx_uzb: value,
            tan_narx_dol: prev.usd_rate > 0 ? Math.round((value / prev.usd_rate) * 100) / 100 : 0,
        }));
    };
    ...
    const handleSaleUzs = (value: number) => {
        setData((prev) => ({
            ...prev,
            saler_narxi: value,
            saler_narxi_dol: prev.usd_rate > 0 ? Math.round((value / prev.usd_rate) * 100) / 100 : 0,
        }));
    };
    ...
    const handleUsdRate = (value: number) => {
        setData((prev) => ({
            ...prev,
            usd_rate: value,
            tan_narx_dol: prev.tan_narx_uzb ? Math.round((prev.tan_narx_uzb / value) * 100) / 100 : 0,
            saler_narxi_dol: prev.saler_narxi ? Math.round((prev.saler_narxi / value) * 100) / 100 : 0,
        }));
    };
