				...
				<div className='space-y-6'>
					<div className='rounded-lg p-4 border shadow'>
						<div className='flex items-center justify-between'>
							...
							<div
								className={`px-3 py-1 rounded-full border text-sm font-medium ${getStatusColor(product?.quantity)}`}
							>
						...
						<div className='space-y-3'>
							...
							<div className='space-y-2'>
								<div className='flex justify-between items-center p-3 rounded-lg border'>
									...
									<span
										className={`font-semibold ${product?.quantity < 0 ? 'text-red-600' : ''}`}
									>
						...
						<div className='space-y-3'>
							...
							<div className='space-y-2'>
								<div className='flex justify-between items-center p-3 rounded-lg border'>
									...
									<span
										className={`font-semibold ${!product?.category?.id && 'text-sm text-amber-300'}`}
									>
										{product?.category?.id
