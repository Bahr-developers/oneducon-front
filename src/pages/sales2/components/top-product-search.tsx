...
export default function TopProductSearch({
  ...
  return (
    <div className="p-4 border-b relative">
      ...
      {open && (
        <Card className="absolute left-4 right-4 top-[72px] z-50 overflow-hidden">
          <ScrollArea className="max-h-[420px]">
            <div className="p-2 space-y-2">
              {results.length === 0 ? (
                <div className="p-4 text-sm text-muted-foreground">Hech narsa topilmadi</div>
              ) : (
                results.map((p) => {
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="text-right">
                          <div className="font-semibold">{Number(p.usd_rate ?? 0)} UZS</div>
