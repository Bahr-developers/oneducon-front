...
const StoreProfile = () => {
    ...
    const updatePassword = useMutation({
        ...
        onError: (err) => {
            const error = err as AxiosError<{ message: string }>;
            toast.error(error.response?.data.message || 'Parol o\'zgartirishda xatolik!');
            console.log(error);
        }
    });
    ...
    if (!storeData) {
        return (
            <div className="flex flex-col items-center justify-center h-screen gap-4">
                ...
                <p className="text-lg text-muted-foreground">Do'kon ma'lumotlari topilmadi</p>
            </div>
        );
    }
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="p-4 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                <p className="text-sm text-yellow-800 dark:text-yellow-200 flex items-start gap-2">
                                    ...
                                    <span>
                                        Parol o'zgartirilgandan so'ng, qayta tizimga kirishingiz kerak bo'lishi mumkin
                                    </span>
                                </p>
                            </div>
                            ...
                            <Button
                                ...
                                disabled={!password || !isPasswordValid || updatePassword.isPending}
                                className="w-full h-12"
                                variant="destructive"
                                size="lg"
                            >
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800 space-y-2">
                                ...
                                <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1 ml-6">
                                    <li>• USD kursi: {storeData?.data?.usd_rate?.toLocaleString() || '0'} UZS</li>
