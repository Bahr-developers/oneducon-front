                ...
                <DialogHeader>
                    ...
                    <div className="flex items-center gap-x-4">
                        <label className="w-full">
                            ...
                            <Input onChange={(e) => setName(e.target.value)} autoFocus placeholder="Mijoz ismini kiriting" className="mt-1 h-12 w-full" />
                        </label>
                        <label className="w-full">
                    ...
                    <Button disabled={!isValid} onClick={handleCreateCustomer} className="w-[250px] mt-5 ml-auto">Qo'shish</Button>
                </DialogHeader>
            </DialogContent>
        </Dialog>
    );
